...
type loopConfig struct {
	maxIterations int
	onToolCall    func(call langrails.ToolCall, result string, err error)
}
...
func WithToolCallHook(fn func(call langrails.ToolCall, result string, err error)) LoopOption {
	return func(c *loopConfig) {
		c.onToolCall = fn
	}
}
